...
The *GNU Privacy Guard*, also known as *GnuPG* or simply *GPG*, is a popular open source OpenPGP ([RFC4880](https://tools.ietf.org/html/rfc4880)) implementation. The system is widely trusted for securing integrity and confidentiality of internet communications through various cryptographic methods. The package manager from [Debian](https://wiki.debian.org/SecureApt) or [Redhat](https://access.redhat.com/security/team/key) use it to verify software downloads, and people like Edward Snowden and [Glenn Greenwald](https://theintercept.com/staff/glenn-greenwald/) use it to secure their email exchanges, to name some applications.

![pubkey](http://jeroenooms.github.io/gpg/pubkey.png)
